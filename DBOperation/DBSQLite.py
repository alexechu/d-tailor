...
class DBSQLite(DBAbstract):
    ...
    def DBGetClosestSolution(self,desiredSolution):
        ...
        query = "SELECT generated_solution_id, sequence FROM generated_solution ORDER BY (" + fields + ") limit 10;"
    ...
    def DBInsertSolution(self,solution,desired_solution_id=""):
        ...
        dict_with_values.update({ (feature+'Position'): self.calculateRelativeScore(feature,solution.levels[feature+'Level'],solution.scores[feature]) for feature in self.designMethod.features })
